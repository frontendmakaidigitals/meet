  ...
  return (
    <>
      <Hero
        ...
        image={"/travel-bags/banner-5.png"}
      ...
      <div className="relative lg:pb-20 ">
        <div className="container py-20">
          <div className="rounded-xl bg-linear-to-b from-amber-50 to-white grid grid-cols-1 items-center gap-9 lg:grid-cols-2 border border-gray-300 p-8">
            ...
            <div className="relative h-[260px] lg:h-[440px] rounded-xl overflow-hidden">
              <Image
                fill
                src={"/travel-bags/img-3.png"}
        ...
        <section className="">
          <Brochure
            img={"/travel-bags/brochure-3.png"}
            title={
