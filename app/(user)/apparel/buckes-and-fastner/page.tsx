      ...
      <section>
        <div className="container relative h-[300px] lg:h-[450px] overflow-hidden lg:rounded-xl">
          ...
          <div className="flex relative z-10 text-white flex-col pb-18 justify-end h-full items-center">
            <h2 className="text-4xl font-rubik mb-2 font-[600]">Buckles</h2>
            <p>
              We supply a comprehensive range of high-quality buckles and
              related accessories to Apparel Manufacturing brands.
            </p>
          </div>
        </div>
      </section>
